...
class ResUsersAnswer {
  ...
  Future<List<Users>> getUsers() async {
    ...
    final List<ResUsersModel> listResUsersModel = usersFromJson(response.data);
    final listUsers = listResUsersModel.map((user) => user.toUserEntity()).toList();
    //final List<dynamic> jsonList = response.data;
    /*final List<Users> users = jsonList.map(
      (json) => ResUsersModel.fromJson(json as Map<String, dynamic>).toUserEntity()
    ).toList();*/
